...
export const PointsAndPenalties: FC = () => [
    ...
    <BulletPoint key="points2">
      <Typography variant="body1">
        ...
        <span style={{ color: theme.palette.primary.main }}>{sectionContent[1].highlight}</span>
      </Typography>
    </BulletPoint>,
    <BulletPoint key="points3">
      <Typography variant="body1">{sectionContent[2].regular}
        <span style={{ color: theme.palette.secondary.main}}>{sectionContent[2].highlight}</span>
      </Typography>
    </BulletPoint>,
    <BulletPoint key="points4">
      <Typography variant="body1">{sectionContent[3].regular}
      <span style={{ color: theme.palette.secondary.main}}>{sectionContent[3].highlight}</span>
      </Typography>
    </BulletPoint>,
];
